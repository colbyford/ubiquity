---
  title: "Peripheral Neuropathy Scalability Demo with `ubiquity` on Azure Machine Learning"
output:
  html_document:
  df_print: paged
---
...
experiment_name <- "pn_ubiquity_experiment"
...
est <- estimator(source_directory = '.',
                 entry_script = 'pn_task.R',
                 script_params = list("--data_folder" = "source_data/"),
...
```{r}
param_sampling <- grid_parameter_sampling(list("scen" = choice(c("S01","S02"))))
...
hyperdrive_run_config = hyperdrive_config(hyperparameter_sampling = param_sampling,
                                          primary_metric_name = 'scen_output',
